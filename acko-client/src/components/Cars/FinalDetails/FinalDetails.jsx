      ...
      <div className="main_div_final">
        <div className="left_div">
          ...
          <div className="verify_deets_text">
            All the information below will show up on your policy. Make sure
            that everything (especially highlighted with ) is correct for a
        ...
        <div className="fd_right_div">
          ...
          <div className="fd_breakdown">
            ...
            <div className="fd_item">
              <p>NCB Discount</p>
              <p className="fd_price_value fd_ncb_discount_text">
                &#8377;{ncbDiscount}
              </p>
            </div>
          ...
          <button
            onClick={() => {
              window.location.href =
                "https://ackoclone-yashraj-m.vercel.app/payment";
            }}
