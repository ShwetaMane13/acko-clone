...
export const AdditionalDetails = () => {
  ...
  const handleClick = (e) => {
    ...
    window.location.href = "https://ackoclone-yashraj-m.vercel.app/otppage";
  };
      ...
      <div className="main_div_additional">
        <div className="left_div">
          ...
          <div className="info_message">
            <p>
              We ask for minimum information required to issue your policy. You
              can always add additional details like nominee details & address
          ...
          <form onSubmit={handleClick}>
            ...
            <p className="email_info">
              Ensure you never miss out on important policy updates by entering
              you most-used email
            </p>
            ...
            <select onChange={handleChange} name="Previous Insurer">
              ...
              {previousInsurer.map((e, i) => {
                return (
                  <option key={i} className="option" value="">
                    {e}
                  </option>
                );
              })}
            ...
            <div className="bottom_div">
              <div className="div_one">
                <input
                  ...
                  type="checkbox"
                />
                <p className="is_comprehensive">
                  My current policy is a comprehensive policy
                </p>
              </div>
              ...
              <div className="div_two">
                ...
                <img
                  className="calendar_svg"
                  src="https://ackoclone-huxly123.vercel.app/static/media/calender.8df16bef.svg"
                  alt=""
                />
              </div>
              ...
              <div className="div_three">
                <img
                  className="previous_policy"
                  src="https://ackoclone-huxly123.vercel.app/static/media/note.1de65e33.svg"
                  alt=""
                />
                <div>
                  <span className="bold">Please note</span> : Previous year
                  policy document is required in case of claim within 30 days of
                  the Acko Policy start date
                </div>
              </div>
            </div>
            ...
            <button onClick={handleClick} className="continue_button">
              Continue
            </button>
          </form>
        </div>
        ...
        <div className="right_div">
          ...
          <div className="breakdown">
            ...
            <div className="item">
              <p>NCB Discount</p>
              <p className="ncb_discount_text price_value">
                -&#8377;{ncbDiscount}
              </p>
            </div>
