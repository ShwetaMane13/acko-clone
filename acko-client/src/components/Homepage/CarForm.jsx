...
export const CarForm = () => {
    ...
    const handleKeyUp = () => {
        ...
        if(status)
        {
            ...
            window.location.href = "http://localhost:3000/car/car-use"
        }
        else
        {
    ...
    return (
        <div className="mid_div">
            ...
            <div className="car_number">
                ...
                <form>
                    <input className="categories_input" onChange={(e) => {setCarNumber(e.target.value)}} type="text" placeholder="Enter your car number"/>
                </form>
            ...
            <div className="div_quote">
                ...
                <p className="quote_text">Save big with our zero commission insurance</p>
